<%-- 
    Document   : header
    Created on : 8/11/2024, 09:03:35 AM
    Author     : walex
--%>
...
<html>
    <head>
        ...
        <title>2do Examen Punto de venta FS</title>
        <!-----------------------------BOOTSTRAP----------------------------->
<!--Icono-->
...
<!-----------------------------/BOOTSTRAP----------------------------->
    ...
    <body style="background-color: yellowgreen">
        <div class="container">
            <div class="jumbotron">
                <center>
                    <h2>2do Examen punto de venta FS</h2>
                    <img src="imagenes/LO.png" class="img-responsive" alt="logo"/>
